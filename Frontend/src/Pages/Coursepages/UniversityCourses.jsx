...
export default function UniversityCourses() {
  ...
  const SkeletonCard = () => (
    <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden animate-pulse flex flex-col h-[350px]">
      ...
      <div className="bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 py-20 relative z-10">
          ...
          <p className="text-lg text-slate-300 max-w-2xl mb-10">
            Explore {courses.length} courses offered by this institution. Find the perfect program to advance your career.
          </p>
          ...
          <div className="max-w-4xl bg-white/10 p-2 rounded-3xl backdrop-blur-md border border-white/20 flex flex-col lg:flex-row gap-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <select
                ...
                className="bg-white rounded-2xl px-4 py-3 text-slate-900 outline-none focus:ring-2 focus:ring-blue-500 sm:w-48 appearance-none font-medium"
              >
              ...
              <select
                ...
                className="bg-white rounded-2xl px-4 py-3 text-slate-900 outline-none focus:ring-2 focus:ring-blue-500 sm:w-40 appearance-none font-medium"
              >
